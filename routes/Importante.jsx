...
function Importante() {
  ...
  return (
    <>
      <header class="cabeca">
        <div id='meu-dia'>
          <img src={atencao} alt="Sol" className='sol' />
          <p>Importante</p>
        </div>
        <div className='icons'>
      ...
      <main id='fundo'>
        <div id='tudo'>
          <div id='barra'>
            ...
            <div>
              <input type="text" value={task} onChange={event => setTask(event.target.value)} placeholder='Adicionar algo importante...' id='Add' />
            </div>
          </div>
